                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <c:forEach items="${articles}" var="article">
                                    ...
                                    <td>
                                        <c:choose>
                                            <c:when test="${article.astate == 0 }">未审核</c:when>
                                            <c:when test="${article.astate == 1}">已审核</c:when>
                                        </c:choose>
                                    </td>
                                    <td>
                                        <c:choose>
                                            <c:when test="${article.astate == 0 }">
                                                <a href="${pageContext.request.contextPath}/article/updateState.do?aid=${article.aid}">通过审核</a>
                                                <a href="${pageContext.request.contextPath}/article/deleteArticle.do?aid=${article.aid}">删除</a>
                                            </c:when>
                                            <c:otherwise>
                                                <a href="${pageContext.request.contextPath}/article/deleteArticle.do?aid=${article.aid}">删除</a>
                                            </c:otherwise>
