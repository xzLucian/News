                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark pro-pic" href=""
                           data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <img src="${pageContext.request.contextPath}/img/users/1.jpg" alt="user" class="rounded-circle" width="31">
                        </a>
                ...
                <ul id="sidebarnav">
                    <li>
                        <div class="user-profile d-flex no-block dropdown m-t-20">
                            <div class="user-pic"><img src="${pageContext.request.contextPath}/img/users/1.jpg" alt="users"
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-8 col-xlg-9 col-md-7">
                    <div class="card">
                        <div class="card-body">
                            <form class="form-horizontal form-material" action="${pageContext.request.contextPath}/article/addArticle.do" method="post">
                                <div class="form-group">
                                    <label class="col-md-12">新闻标题</label>
                                    <div class="col-md-12">
                                        <input type="text" class="form-control form-control-line" name="atitle"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">新闻图片链接</label>
                                    <div class="col-md-12">
                                        <input type="text" class="form-control form-control-line" name="imgSrc"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-12">新闻种类</label>
                                    <div class="col-sm-12">
                                        <select class="form-control form-control-line" name="atype">
                                ...
                                <div class="form-group">
                                    <label class="col-md-12">新闻内容</label>
                                    <div class="col-md-12">
                                        <textarea rows="5" class="form-control form-control-line" name="acontent"></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-12">
                                        <button class="btn btn-success">发布新闻</button>
                                    </div>
                                </div>
                            </form>
                        </div>
