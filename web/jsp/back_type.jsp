            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                            ...
                            <table class="table">
                                ...
                                <c:forEach items="${types}" var="type">
                                    <tr>
                                        ...
                                        <td>
                                            <a href="${pageContext.request.contextPath}/article/deleteType.do?typeName=${type}">删除</a>
                                        </td>
                                    </tr>
                                </c:forEach>
                                </tbody>
                        ...
                        <form action="${pageContext.request.contextPath}/article/addType.do" method="post">
                            &nbsp;&nbsp;&nbsp;
                            新分类名称：
